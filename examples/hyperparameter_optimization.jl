...
optimization = DistributedHyperOpt.Optimization(
    ...
    DistributedHyperOpt.Parameter(
        ...
        samples = 4,
        round_digits = 6,
    ),       # step size with logarithmic scale
...
)    # redirect the processes i/o into a seperate directory, don't do this if you are still debugging!!!

# save optimization results
DistributedHyperOpt.saveOptimization(
    optimization,
    joinpath(@__DIR__, "logs", "myOptimizationResults.jld2"),
)
